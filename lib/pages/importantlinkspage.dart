...
class ImportantLinksPage extends StatefulWidget {
  const ImportantLinksPage({Key? key, required this.title}) : super(key: key);
...
class _ImportantLinksPageState extends State<ImportantLinksPage> with KeyboardHiderMixin {
  @override
  void initState() {
