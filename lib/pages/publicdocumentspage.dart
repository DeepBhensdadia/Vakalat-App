...
class PublicDocumentsPage extends StatefulWidget {
  const PublicDocumentsPage({Key? key, required this.title}) : super(key: key);
...
class _PublicDocumentsPageState extends State<PublicDocumentsPage> with KeyboardHiderMixin {
  @override
  void initState() {
