...
class Videos_Screen extends StatefulWidget {
  const Videos_Screen(
      {Key? key, required this.title, required  this.datavideo,})
      : super(key: key);

  final String title;
  final VideosDatum datavideo;


  @override
  State<Videos_Screen> createState() => _Videos_Screen_State();
}

class _Videos_Screen_State extends State<Videos_Screen>
    with KeyboardHiderMixin {
  // Video objVideoCurrent = Video();
  ...
  void initState() {
    ...
    loadVideo(widget.datavideo.plainUrl);
